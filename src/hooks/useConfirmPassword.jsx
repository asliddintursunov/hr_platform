...
export function useConfirmPassword() {
  ...
  const passwordMatchChecker = () => (passwordMatchValue === passwordValue ? setValidPasswordMatchChecker("Password Mos Keldi") : setValidPasswordMatchChecker("Password Mos Kelmadi"))
