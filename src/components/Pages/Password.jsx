function Password({ passwordValue, setPasswordValue, validPasswordChecker,
  ...
  return (
    <>
      <label style={{ position: 'relative', maxWidth: 'min-content', lineHeight: '1.2rem' }}>
        <input style={passwordValue.length >= 1 && passwordTrue ? passwordInputStyle : null} value={passwordValue} type={passwordType ? "password" : "text"} placeholder='Password'
