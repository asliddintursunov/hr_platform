        ...
        <div className={styles.PopUpWrapper}>
          ...
          >
            ...
            <form onSubmit={handleChangePassword} className={styles.InputContainer}>
              <OldPassword oldPassword={oldPassword} setOldPassword={setOldPassword} changeProfile={changeProfile} />
              <EditPassword
              ...
              />
              <Button disabled={passwordValue === passwordMatchValue && passwordValue.length > 0 && passwordMatchValue.length > 0 && oldPassword.length > 0 ? false : true}>Update</Button>
              <Button type="button" color="red" onClick={() => setChangePassword(false)}>
                <Cross1Icon />
              </Button>
            </form>
          </div>
